...
//float hr_b[5] = {0.02785976604,0,-0.05571953207,-2.547070265,0.02785976604};
//float hr_a[5] = {1, -3.341346025,4.306058407,-2.547070265,0.5869194865};
...
void Breath_filter(float *OriginalSignal)
{
	...
	// for(int i=0;i<ADC_NUM;i++) OriginalSignal[i] = SignalFilter[i];
}
